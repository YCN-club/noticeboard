...
abstract class $PostModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int ms, String query, List<ResultModel> result});
}
...
class _$PostModelImpl with DiagnosticableTreeMixin implements _PostModel {
  const _$PostModelImpl(
      {required this.ms,
      required this.query,
      required final List<ResultModel> result})
      : _result = result;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PostModel(ms: $ms, query: $query, result: $result)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, ms, query, const DeepCollectionEquality().hash(_result));
...
abstract class _PostModel implements PostModel {
  const factory _PostModel(
      ...
      required final List<ResultModel> result}) = _$PostModelImpl;
