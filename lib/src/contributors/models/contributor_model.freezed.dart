...
ContributorModel _$ContributorModelFromJson(Map<String, dynamic> json) {
  return _ContributorModel.fromJson(json);
}

/// @nodoc
mixin _$ContributorModel {
  ...
  @JsonKey(ignore: true)
  $ContributorModelCopyWith<ContributorModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ContributorModelCopyWith<$Res> {
  factory $ContributorModelCopyWith(
          ContributorModel value, $Res Function(ContributorModel) then) =
      _$ContributorModelCopyWithImpl<$Res, ContributorModel>;
  @useResult
  $Res call(
      {String login,
      int id,
...
/// @nodoc
class _$ContributorModelCopyWithImpl<$Res, $Val extends ContributorModel>
    implements $ContributorModelCopyWith<$Res> {
  _$ContributorModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ContributorModelImplCopyWith<$Res>
    implements $ContributorModelCopyWith<$Res> {
  factory _$$ContributorModelImplCopyWith(_$ContributorModelImpl value,
          $Res Function(_$ContributorModelImpl) then) =
      __$$ContributorModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String login,
...
/// @nodoc
class __$$ContributorModelImplCopyWithImpl<$Res>
    extends _$ContributorModelCopyWithImpl<$Res, _$ContributorModelImpl>
    implements _$$ContributorModelImplCopyWith<$Res> {
  __$$ContributorModelImplCopyWithImpl(_$ContributorModelImpl _value,
      $Res Function(_$ContributorModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ContributorModelImpl(
      login: null == login
          ? _value.login
          : login // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$ContributorModelImpl
  ...
  factory _$ContributorModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$ContributorModelImplFromJson(json);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ContributorModel'))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ContributorModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ContributorModelImplCopyWith<_$ContributorModelImpl> get copyWith =>
      __$$ContributorModelImplCopyWithImpl<_$ContributorModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ContributorModelImplToJson(
      this,
    );
  }
}

abstract class _ContributorModel implements ContributorModel {
  const factory _ContributorModel(
      ...
      required final int contributions}) = _$ContributorModelImpl;

  factory _ContributorModel.fromJson(Map<String, dynamic> json) =
      _$ContributorModelImpl.fromJson;
